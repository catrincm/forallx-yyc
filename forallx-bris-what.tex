...
\todo{Nice philosophical argument example?}
...
\end{center}
Arguments as you read them in philosophy texts may have a more complicated structure, typically by chaining together simple arguments like this, so they may have \emph{intermediate conclusions}. But we will analyse this simple structure to give us the tools to understand the more complex arguments as we will come across them throughout philosophy. They might have a structure more like:
\begin{center}
\begin{tikzpicture}
...
\todo{I deleted the inductive arguments section...}

\section{Other kinds of good arguments}
\todo[inline]{Talk about evidential support etc.}
...
There are other cases where the premises might support the conclusion without 
...
We can also ask about the logical relations \emph{between} two sentences. \todo{I didn't like this last time!! I don't remember why... }
