...
\close        
\have{if}{\enot (G \eor H)\eif \bot}\ifI{ncon-bot2}
\have{con}{G \eor H}\notE{if}
\end{pf}
}
...
\close
\have{if}{\enot P\eif \ered}\ifI{np-red1}
\have{con}{P}\notE{if}
\end{pf}}
\end{earg}
...
\close
\have{if}{\enot(N\eor\enot N)\eif \ered}\ifI{ncon-bot2}
...
\open
	...
	\close
	\have{if}{\enot A\eif \ered}\ifI{aba-red1}
	\have{a2}{A}\notE{if}
\close
...
\close
\have{if}{\enot G\eif \ered}\ifI{ng-bot2}
\have{con}{G}\notE{if}
\end{pf}}
...
\close
\have{if}{\enot N\eif \ered}\ifI{nN-red}
\have{N}{N}\notE{if}
...
\open
	...
	\close
	\have{if}{\enot H\eif\ered}\ifI{nh-red2}
	\have{h2}{H}\notE{if}
\close
\open
	\hypo{h3}{H}
