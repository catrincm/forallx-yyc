...
Suppose that \meta{A} is an expression with that $\meta{x}$ is free in $\meta{A}$ (i.e.~no quantifiers $\forall\meta{x}$ or $\exists\meta{x}$ already). We will write this thus:
