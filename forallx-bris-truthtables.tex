...
We can check these with truth tables. But we can see


  
Some more fallacies:
\begin{itemize}
\item Begging the question.  Conclusion implicit in premises. Valid.\begin{quote}
...
\item False dilemma (/false dichotomy).  Ignores other options.\\Implicitly uses premise $A\eor B$. \begin{quote}
we can't
...
such a crime cannot be allowed to go unpunished.\end{quote}
%\item Equivocation. 
%\item Lots more
