...
\begin{pf}
	...
	\have[8]{ab}{S\eif F}\by{?}{assn2}
	\have[\ ]{dots}{\;\raise-.65ex\hbox{\vdots}}
	\have[15]{a}{S}\by{?}{assn1}
	\have[\ ]{dots}{\;\raise-.65ex\hbox{\vdots}}
	\have[23]{b}{F} \ce{ab,a}
\end{pf}
...
\begin{pf}
	\have[8]{a}{R}\hspace*{1em}
	\have[15]{b}{L}\hspace*{1em}
	\have[23]{c}{R \eand L} \ai{a, b}\hspace*{1em}
\end{pf}
...
The rules we give, then, are basically versions of the rules for conjunction:
\factoidbox{
\begin{pf}
\ellipsesline
...
\begin{pf}
	\hypo{r}{\text{Ludwig is reactionary}}
	\open
		\hypo{l}{\text{Suppose that he is libertarian}}
		\have{rl}{\text{Then he is both reactionary and reactionary}}\ai{r, l}
		\close
	\have{con}{\parbox[t]{.8\textwidth}{Thus, \emph{if} he is libertarian, then he is both libertarian and reactionary.}}\ci{l-rl}
\end{pf}\medskip  
