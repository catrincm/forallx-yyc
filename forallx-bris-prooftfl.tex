...
\section{Biconditional}\todo{delete this!}
...
We will add a final rule to our system. Here's the motivation for it: it's either raining or it's not raining. The Law of Excluded Middle encodes the idea that every sentence is either true or false: either $\meta{A}$ or $\neg\meta{A}$. The rule simply says that you're always allowed to write $\meta{A}\eor\neg\meta{A}$:

\factoidbox{
\begin{proof}
\have[i]{lem}{\meta{A}\eor\enot\meta{A}}\LEM
\end{proof}
} 
